...
class MainDashboard extends Page
{
    ...
    {
        $query = Registro::select('registrable_type', DB::raw('count(*) as total'))
    ...
    public function getRegistros()
{
    ...
    $query = Registro::join('users', 'registros.user_id', '=', 'users.id')
        ->select('registros.*', 'users.name as user_name', 'users.apellidos as user_apellidos','users.departamento_id as user_departamento_id')
